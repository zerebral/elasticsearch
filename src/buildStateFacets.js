...
export default function buildStateFacets(aggregations) {
  //const states = getValueFacet(aggregations, "state");
  //const city = getValueFacet(
  //  aggregations,
  //  "city"
  //);
  //const seed_group_name = getRangeFacet(aggregations, "seed_group_name");
  //const seed_group_id = getValueFacet(aggregations, "seed_group_id");
